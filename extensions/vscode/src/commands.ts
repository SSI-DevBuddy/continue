...
const getCommandsMap: (
  ...
  return {
    "ssidevbuddy.acceptDiff": async (newFileUri?: string, streamId?: string) =>
      processDiff(
        "accept",
        sidebar,
        ide,
    ...
    "ssidevbuddy.rejectDiff": async (newFilepath?: string, streamId?: string) =>
      processDiff(
        "reject",
        sidebar,
        ide,
    ...
    "ssidevbuddy.acceptVerticalDiffBlock": (fileUri?: string, index?: number) => {
      captureCommandTelemetry("acceptVerticalDiffBlock");
      verticalDiffManager.acceptRejectVerticalDiffBlock(true, fileUri, index);
    },
    "ssidevbuddy.rejectVerticalDiffBlock": (fileUri?: string, index?: number) => {
    ...
    "ssidevbuddy.toggleFullScreen": async () => {
      focusGUI();
